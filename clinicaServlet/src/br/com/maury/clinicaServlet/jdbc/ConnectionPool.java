...
public class ConnectionPool {
	...
	/*public ConnectionPool() throws Exception {
		//Este construtor cria a pool de conex�es 
		String portaMySQL = "3306";
		...
		this.dataSource = pool;
		System.out.println("Qtd de conex�es: "+pool.getNumBusyConnections());
	} */
	
	public static Connection getConnection() throws SQLException {
		/*	Este m�todo retorna uma conex�o
		 * */
		//Connection con = this.dataSource.getConnection();
		Connection con = dataSource.getConnection();
		//System.out.println("Conex�es abertas: "+combo.getNumConnections());
