...
public class TestaLoginComLista {
	...
	public static void imprimiListaLogin(Collection<Object> listaLogin) {
		...
		System.out.println("ID do funcion�rio: " + funcionario.getIdPessoaFisica());
		System.out.println("Nome do funcion�rio: " + funcionario.getNome());
		System.out.println("Sobrenome do funcion�rio: " + funcionario.getSobrenome());
		System.out.println("ID do usu�rio: " + usuario.getId());
		System.out.println("Tipo de usu�rio: " + usuario.getTipoUsuario());
		System.out.println("M�DULOS: ");
		for (Modulo modulo : usuario.getModulos()) {
			System.out.println("ID do m�dulo: " + modulo.getId());
			System.out.println("Nome do m�dulo: " + modulo.getNomeModulo());
		}
	}
			...
			try (PreparedStatement pstm = con.prepareStatement(sql)) {
				...
				try (ResultSet rs = pstm.getResultSet()) {
					if (rs.next()) {
						...
						if (ativo == false) {
							System.out.println("USU�RIO INV�LIDO OU INATIVO");
						}
