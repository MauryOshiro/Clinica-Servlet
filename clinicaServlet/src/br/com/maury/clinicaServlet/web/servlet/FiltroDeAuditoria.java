...
/*
 *	Na linha abaixo deve colocar todas as servlets que o filtro ir� monitorar
...
public class FiltroDeAuditoria implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (funcionario == null) {
			//session.invalidate();
			session.setAttribute("falhaLogin", "Sess�o expirada. Favor realizar o login novamente.");
